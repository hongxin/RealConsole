...
impl LlmToPipeline {
    ...
    pub fn new(llm_client: Arc<dyn LlmClient>) -> Self {
        Self {
            llm_client,
            // 从 i18n 加载 Intent 提示词（支持多语言）
            system_prompt: crate::i18n::t("prompts.intent.file_operations"),
        }
    }
...
// ========== System Prompt ==========
// Note: Intent system prompt now loaded from i18n (locales/*-prompts.yaml)
// Key: prompts.intent.file_operations
